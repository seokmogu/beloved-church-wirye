...
const guideSections = [
  {
    ...
    publicHref: '/',
    publicLabel: '메인 화면',
    summary: '히어로 문구와 메인 하단 섹션의 노출 여부, 섹션 제목과 설명을 수정합니다.',
    steps: [
      '히어로 영역의 교회명, 제목, 부제목, 버튼 문구와 링크를 수정합니다.',
      '홈 섹션에서 공지사항, 최신 설교, 인스타그램, 오시는 길 표시 여부를 조정합니다.',
      '저장 후 메인 화면에서 히어로와 각 섹션 제목이 바뀌었는지 확인합니다.',
    ],
  },
  {
