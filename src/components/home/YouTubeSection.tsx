            ...
            >
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  ...
                  <h3 className="max-w-2xl text-xl font-bold leading-tight text-white md:text-2xl">
                    {featured.title}
                  </h3>
                  <time
                    className="mt-2 block text-sm text-white/72"
          ...
          <div className="rounded-lg border border-dashed border-border bg-card/70 px-6 py-10 text-center">
            ...
            {channelUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 inline-flex rounded-md border border-border px-4 py-2 text-sm font-semibold text-primary transition-colors hover:border-primary/30 hover:bg-primary/5"
              >
                YouTube 채널 &rarr;
              </a>
            )}
